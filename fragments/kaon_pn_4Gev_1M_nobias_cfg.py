...
sim.runNumber = 0
sim.description = "Target photo-nuclear, xsec bias 1"
...
sim.biasing_operators = [ bias_operators.PhotoNuclear('target_region',1.,2500.,only_children_of_primary=True) ]
...
p.termLogLevel = 0
p.logFrequency = 1000
p.outputFiles = [ 'pn_kaonfilter_bias_1M_events_r%04d_b%d.root'%(p.run,args.batch_job) ]
